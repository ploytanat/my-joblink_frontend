...
export default {
  ...
  methods: {
    ...
    saveProfile() {
      ...
      // ใช้ค่าในตัวแปร firstName, lastName, birthdate, phone_number, gender, email, address
        const data = {
    ...
    resetProfile() {
      // รีเซ็ตค่าตัวแปร firstName, lastName, birthdate, phone_number, gender, email, address ให้เป็นค่าเดิม
    },
  },
  validations: {
    firstName: {
